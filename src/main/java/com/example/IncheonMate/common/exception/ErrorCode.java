...
public enum ErrorCode {
    ...
    AI_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "SERVER 002","FastAPI와 통신중 오류가 발생했습니다."),
    ODSAY_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR,"ROUTE 003","ODsay 서버 내부 오류가 발생했습니다."),
    KAKAO_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "SERVER 003", "Kakao API와 통신중 오류가 발생했습니다.");
