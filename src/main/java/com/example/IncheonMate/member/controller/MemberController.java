...
public class MemberController {
    ...
    public ResponseEntity<MyInfoResponse.FavoritePlacesDto> getFavoritePlaces(@AuthenticationPrincipal CustomOAuth2User user){
    ...
    public ResponseEntity<MyInfoResponse.MyWalletDto> getMyWalletUri(@AuthenticationPrincipal CustomOAuth2User user){
    ...
    public ResponseEntity<OnboardingService.SasangResultResponse> updateSasang(@AuthenticationPrincipal CustomOAuth2User user,
                                                                               @RequestBody SasangAnswerDto sasangAnswerDto){//SasangResultResponse를 record에서 dto로 변환해야함
    ...
    public ResponseEntity<MyInfoResponse.ProfileUpdateDto> updateProfile(@AuthenticationPrincipal CustomOAuth2User user,
                                                                         @RequestBody MyInfoResponse.ProfileUpdateDto profileUpdateDto){
